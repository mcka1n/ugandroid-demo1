...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize buttons (applying cast)
        btnSearch = (Button) findViewById(R.id.btnSearch);
        btnOpenActivity = (Button) findViewById(R.id.btnOpenActivity);
        // Specify to the buttons which Listener is gonna be ready for them.
    ...
    class ButtonListener implements OnClickListener {
    	...
    	public void onClick(View v){
    		...
    		//Toast.makeText(getApplicationContext(), "OMG Hizo Click!!", Toast.LENGTH_SHORT).show();
